...
import ojy.spring.web.common.JDBCUtil;
@Repository("boardDAO")
public class BoardDAO {
	...
	private final String BOARD_DELETE = "delete myboard where seq=?"; private final String BOARD_GET = "select * from myboard where seq=?";
